...
Shader "Shader Forge/Examples/Refraction" {
    Properties {
        ...
        _node_9518 ("node_9518", Color) = (0.5,0.5,0.5,1)
...
////// Specular:
                ...
                float3 diffuseColor = _node_9518.rgb; // Need this for specular when using metallic
